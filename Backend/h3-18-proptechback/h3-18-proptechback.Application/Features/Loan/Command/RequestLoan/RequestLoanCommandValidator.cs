    ...
    public class RequestLoanCommandValidator : AbstractValidator<RequestLoanCommand>
    {
        public RequestLoanCommandValidator()
        {
            ...
            RuleFor(x => x.Guarantor1).NotNull().WithMessage("El primer garante es obligatorio.")
                .SetValidator(new RequestLoanGuarantorCommandValidator());

            RuleFor(x => x.Guarantor2).NotNull().WithMessage("El segundo garante es obligatorio.")
                .SetValidator(new RequestLoanGuarantorCommandValidator());
        }
    }
    public class RequestLoanGuarantorCommandValidator : AbstractValidator<RequestLoanGuarantorCommand>
    {
        public RequestLoanGuarantorCommandValidator()
        {
            RuleFor(x => x.Name)
